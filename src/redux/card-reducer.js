...
let initialState = {
    ...
    cardsData: [
        ...
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299", id:2, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик для унитаза', cost:"309" , id:3, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:4, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:5, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:6, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:7, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:8, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:9, disable: false, inButton: 'В корзину'},
        {sale:true, img:"shop-image.png", 
        nameCard:'Ершик кокосовый для чистки бутылочек', cost:"299" , id:10, disable: false, inButton: 'В корзину'},
    ],
    basket: [
    ],
    basketLenght: 0
